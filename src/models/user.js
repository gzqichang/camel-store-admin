import { query, queryUser, testerUser, bonusUser, rebateUser, videoUser, AccountCreditlist,
  queryAdmin, setpwdAdmin, createAdmin, readAdmin, updateAdmin, delAdmin, queryAdmingroup,
  getFeedbackList
} from '@/services/user';
