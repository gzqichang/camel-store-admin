  ...
  columns = [
    ...
    },
    {
      ...
      render: (t, r) => (
        <span
          onClick={() =>
            this.handleModalUser(r.url, t, r.nickname, "upload_perm")
          }
          style={{ cursor: "pointer" }}
        >
          {t ? (
  ...
  switch = () => {
    ...
    const bonus = {
      ...
      render: (t, r) => (
        <span
          onClick={() =>
            this.handleModalUser(r.url, t, r.nickname, "bonus_right")
          }
          style={{ cursor: "pointer" }}
        >
          {t === "true" ? (
    ...
    const rebate = {
      ...
      render: (t, r) => (
        <span
          onClick={() =>
            this.handleModalUser(r.url, t, r.nickname, "rebate_right")
          }
          style={{ cursor: "pointer" }}
        >
          {t === "true" ? (
