...
import { Form, Button, Card, Spin, message, Modal } from "antd";
            ...
            <Form>
              ...
              >
                <UploadImage
                  ...
                  onChange={(e, list) =>
                    this.handleUpload(e, "square_logo", list)
                  }
                  handleSource={() =>
                    this._openModal(
                      "square_logo",
                      square_logo ? [square_logo].length < 1 : []
                    )
                  }
              ...
              >
                <UploadImage
                  ...
                  onChange={(e, list) =>
                    this.handleUpload(e, "rectangle_logo", list)
                  }
                  handleSource={() =>
                    this._openModal(
                      "rectangle_logo",
                      rectangle_logo ? [rectangle_logo].length < 1 : []
                    )
                  }
                  restprops={{ openFileDialogOnClick: false }}
                />
