...
import { Form, Button, Card, Spin, Icon, Avatar, message, Modal } from "antd";
            ...
            modal.update({
              ...
              onCancel: () => {
                return dispatch({
                  ...
                  if (res.message) message.info(res.message);
                  modal.destroy();
                });
              },
              onOk: () => {
              ...
              content: (
                ...
                >
                  <img alt="logo" src={`data:image/png;base64,${code}`} />
                    ...
                    title={
                      <div>
                        ...
                        >
                          ...
                          <Button.Group>
                            <Button className={style.text} disabled>
                              ￥{item.price}/{item.duration}天
                            </Button>
                            <Button
                              type="primary"
                        ...
                        {item.isBrought && (
                          ...
                          >
                            有效期至：
                            {moment(item.expired).format("YYYY-MM-DD")}
                          </div>
                        )}
                      </div>
                    }
