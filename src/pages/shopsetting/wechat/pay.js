        ...
        <Spin spinning={loading}>
            ...
            extra={
              <Fragment>
                {isEdit ? (
                  ...
                  <Button type={"primary"} onClick={this.toggleIsEdit}>
                    编辑
                  </Button>
                )}
              </Fragment>
          ...
          >
            <Form>
              <FormItem label={"支付渠道"}>
                <Select
                  value={payInfo.switch}
                  style={{ width: 300 }}
                  onChange={e =>
                    this.setState({ payInfo: { ...payInfo, switch: e } })
                  }
                >
                  {storeType === "cloud" && (
                    <Option key={"false"}>微信支付（需要公账）</Option>
                  )}
              ...
              {storeType === "cloud" && (
                <TabPane tab={"微信支付（需要公账）"} key={"1"}>
                  ...
                  >
                    ...
                    <p>
                      <b>商户号：</b>
                      即微信商户平台登录账号，查看流程：打开微信商户平台，点击
                      “账号中心 - 个人信息” 进行查看；
                    </p>
                    <p>
                      <b>商户KEY：</b>
                      查看流程：打开微信商户平台，点击 “账户中心 - API安全 -
                      设置密钥” 进行查看
                    </p>
                    <p>
                      <b>商户证书：</b>
                      即API证书：apiclient_cert.pem文件
                    </p>
                    <p>
                      <b>商户私钥：</b>
                      即API证书：apiclient_key.pem文件
                    </p>
                  </Card>
                </TabPane>
              )}
              <TabPane tab={"payJs（个人收款）"} key={"2"}>
                <Form>
                  <FormItem label={"payJs商户号"}>
                    <Input
                      ...
                      onChange={e =>
                        this.setState({
                          payInfo: { ...payInfo, mchid: e.target.value }
                        })
                      }
                    />
                  </FormItem>
                  <FormItem label={"payJs通信密钥"}>
                    <Input
                      ...
                      onChange={e =>
                        this.setState({
                          payInfo: { ...payInfo, key: e.target.value }
                        })
                      }
                    />
                  </FormItem>
                ...
                >
                  ...
                  <p>
                    <b>payJs支付：</b>
                    支持个人支付，需要前往payJs（
                    <a href={"https://payjs.cn"} target={"_blank"}>
                      https://payjs.cn
                    </a>
                    ）注册和认证，获取商户号和密钥，填入上表，并切换支付渠道为“payJs（个人收款）”即可。设置后请上架低价商品进行测试，确保成功支付。
                  </p>
                  <p>
                    <b>商户号和密钥：</b>
                    扫码登录payJs管理后台，在“会员中心”找到“商户号”和“通信密钥”
                  </p>
                  <p>
                    <b>费用：</b>
                    payJs需要收取的费用，具体见：
                    <a href={"https://payjs.cn/price"} target={"_blank"}>
                      https://payjs.cn/price。
                    </a>
                  </p>
