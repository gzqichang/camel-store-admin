...
class Storelist extends Component {
    ...
    },
    {
      ...
      render: (t, r) => (
        <Fragment>
          ...
          <Link
            to={{
              pathname: `/setting/storelist/editstore`,
              query: { id: r.id }
            }}
          >
            <span>编辑</span>
    ...
    dispatch({
      ...
      if (res && res.length === 0 && getLocalStorage("shopid") !== "all") {
        dispatch({
          ...
          payload: { shopurl: "all", shopid: "all" }
        });
      }
    });
  };
  ...
  statusHandle = (status, id, name) => {
    ...
    Modal.confirm({
      title: "确认操作",
      content: `确认把 ${name} 门店的状态切换为 ${
        status === "close" ? "休息中" : "营业中"
      }`,
      centered: true,
      okText: "确定",
      okType: "danger",
                ...
                <Fragment>
                  <div className={styles.searchitem}>
                    ...
                    <Input
                      ...
                      onChange={e => {
                        this.handletradeform(e.target.value, "name__contains");
                      }}
                      placeholder="请输入门店名称"
                      style={{ width: 200 }}
                    />
                  ...
                  <div className={styles.searchitem}>
                    ...
                    <Input
                      ...
                      onChange={e => {
                        this.handletradeform(e.target.value, "address");
                      }}
                      placeholder="请输入门店地址"
                      style={{ width: 200 }}
                    />
