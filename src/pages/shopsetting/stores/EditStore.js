...
class EditStore extends Component {
  ...
  validatingForm = args => {
    ...
    if (
      args.delivery_divide === "geometry" &&
      args.delivery_range &&
      args.delivery_range.length < 3
    ) {
        ...
        >
          <Form className={styles.editform}>
            ...
            <FormItem label="门店地址">
              ...
              />
              <Button onClick={this.converhandle} type="primary">
                转换坐标
              </Button>
            </FormItem>
            <FormItem
              label="门店坐标"
              style={storeform.lat || storeform.lng ? {} : { display: "none" }}
            >
              <Fragment>
            ...
            <FormItem
              label="服务半径（米）"
              style={
                storeform.delivery_divide === "radius"
                  ? {}
                  : { display: "none" }
              }
            >
              <Input
                ...
                onChange={e =>
                  this.handleStoreform("delivery_radius", e.target.value)
                }
              />
            </FormItem>
            <FormItem
              label="门店配送区域"
              style={
                storeform.delivery_divide === "geometry"
                  ? {}
                  : { display: "none" }
              }
            >
            ...
            >
              ...
              >
                ...
                {storelist
                  .filter(
                    item => item.id !== storeform.id && item.entrust === null
                  )
                  .map(item => (
            ...
            <FormItem label="门店管理员" required={false}>
              ...
              >
                {adminlist.map(item => (
                  <Option key={item.url}>{item.username}</Option>
                ))}
              </Select>
            </FormItem>
            <FormItem label="客服电话" required={false}>
              <Input
                ...
                onChange={e =>
                  this.handleStoreform("service_phone", e.target.value)
                }
              />
            </FormItem>
          </Form>
