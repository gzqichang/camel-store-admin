...
class Expand extends Component {
  ...
  handleSelect = () => {
    ...
    const store_poster = {..._selectList[0], key: undefined, index: undefined }
      ...
      <PageHeaderWrapper >
        <Spin spinning={loading}>
          <Card title="门槛"
                ...
                extra={<Button type='primary' style={{ marginLeft: 8 }} onClick={this.handleSubmit}>保存</Button>}>
            { bonus_switch ?
            <Form className={styles.editform}>
              <FormItem label="分销返佣门槛（元）" required {...formItemLayout}
          ...
          <Card title="海报"
                extra={<Button type='primary' style={{ marginLeft: 8 }} onClick={() => this.handleSubmitposter()}>保存</Button>}>
            {bonus_switch ?
              <Form className={styles.editform}>
