...
class Msglist extends Component {
  ...
  columns = [
    ...
    },
    {
      ...
      render: (t, r) => (
        <span
          onClick={() => this.handleModaluse(r.id, !t, r.title)}
    ...
    },
    {
      ...
      render: (t, r) => (
        <Fragment>
          ...
          <Link
            to={{
              pathname: `/trade/shopmessage/editmessage`,
              query: { id: r.id }
            }}
          >
            <span>编辑</span>
              ...
              renderSimpleForm={() => (
                <Fragment>
                  ...
                  <div className={styles.searchitem}>
                    ...
                    <RangePicker
                      value={
                        shopform.create_time_after
                          ? [
                              moment(shopform.create_time_after, "YYYY-MM-DD"),
                              moment(shopform.create_time_before, "YYYY-MM-DD")
                            ]
                          : null
                      }
