...
class Videolist extends Component {
  ...
  columns = [
    ...
    },
    {
      ...
      key: "video",
      render: (t, r) => (
        <span onClick={() => this.previewVideo(t)}>
      ...
      <PageHeaderWrapper>
            ...
            <div style={{ marginBottom: 20 }}>
              <Row>
                <Col span={12}>
                  是否开启短视频功能：
                  <Switch
                    checked={video_switch}
                    onChange={e => this.changeVideoSwitch(e)}
                  />
                </Col>
        ...
        >
          <Input
            ...
            onChange={e => {
              ...
              this.setState({
                videoDetail: { ...videoDetail, title: e.target.value }
              });
            }}
          />
        </Modal>
        ...
        >
          <video
            src={videoSrc}
            controls
            style={{ maxWidth: "100%", maxHeight: `${wh - 360}px` }}
          />
        </Modal>
      </PageHeaderWrapper>
    );
