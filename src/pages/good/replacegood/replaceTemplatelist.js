...
import { Button, Card, DatePicker, Row, Col, Select, Input, Spin } from "antd";
          ...
          <Row>
            {addsubgoodTemplate ? (
              <Col span={12}>
                <Link
                  to={{
                    pathname: `/good/template/replacetemplete/replaceEditTemplete`,
                    query: { id: null }
                  }}
                >
            ...
            <Col
              span={12}
              offset={addsubgoodTemplate ? 0 : 12}
