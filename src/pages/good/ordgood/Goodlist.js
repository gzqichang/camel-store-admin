...
class Goodlist extends Component {
  ...
  initData = (type) => {
    const { dispatch, searchform:{ good } } = this.props;
  ...
  render(){
    ...
    return(
      ...
      <Card className={styles.main}>
        ...
        <Link to={{pathname:`/good/ordgood/goodlist/editgood`, query: { id:null} }}>
          <Button type='primary' style={{ marginBottom: 20 }}>新增商品</Button>
        </Link>
