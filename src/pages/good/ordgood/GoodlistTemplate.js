...
class GoodlistTemplate extends Component {
  ...
  initData = (type) => {
    const { dispatch, searchform:{ goodtem } } = this.props;
    ...
    return(
      ...
      <Card className={styles.main}>
            ...
            renderSimpleForm={() =>
              <Fragment>
                ...
                <div className={styles.searchitem}>
                  ...
                  <CategorySelect type="search"
                                  newprops={{ style:{width: 200} }}
                                  value={goodform.category}
                                  onChange={(e) => this.handlegoodform('category',{target: {value:e}})}/>
                </div>
                {/*<div className={styles.searchitem}>*/}
                ...
                <div className={styles.searchitem}>
                  <span className={styles.searchitem_span}>是否热门商品: </span>
                  <Select value={goodform.recommendation}
                          onChange={(e) => this.handlegoodform('recommendation',{target: {value:e}}) }
                          style={{ width: 200 }}>
                ...
                <div className={styles.searchitem}>
                  <span className={styles.searchitem_span}>是否拼团商品: </span>
                  <Select value={goodform.groupbuy}
                          onChange={(e) => this.handlegoodform('groupbuy',{target: {value:e}}) }
                          style={{ width: 200 }}>
                    <Option key="是" value={true}>是</Option>
                    <Option key="否" value={false}>否</Option>
                  </Select>
        ...
        <Row>
          {createTem ?
            <Col span={12}>
              <Link to={{ pathname: `/good/template/goodlistTemplate/editgoodTemplate`, query: { id: null} }}>
                <Button type='primary' style={{ marginBottom: 20 }}>新增商品模板</Button>
              </Link>
            </Col>
            : null
          }
          <Col span={12} offset={createTem ? 0 : 12} style={{ textAlign:'right',marginBottom: 20 }}>
