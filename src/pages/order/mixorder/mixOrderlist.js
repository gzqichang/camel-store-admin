...
class mixOrderlist extends Component {
  ...
  openModal = (record, key) => {
    this.setState({
      visible: true,
      robot: record.robot,
      robot_goods: record.robot_goods,
      rowdata: { ...record }
    });
  };
    ...
    const columns = [
        ...
        render: (t, r) => (
          <span>
            ...
            {r.status === "build" ? (
              <Fragment>
                <br />
                <a onClick={() => this.openModal(r, r.key)}>编辑</a>
              </Fragment>
            ) : null}
          </span>
        )
      },
      {
        ...
        render: (t, r) => (
          <CountDown
            style={{ fontSize: 16 }}
            target={new Date(r.end_time).getTime()}
          />
        )
      },
      {
                  ...
                  <Fragment>
                    <div className={styles.searchitem}>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          this.handleOrderform(e.target.value, "ptgroup_no")
                        }
                        placeholder="请输入拼团号"
                        style={{ width: 200 }}
                      />
                    ...
                    <div className={styles.searchitem}>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          this.handleOrderform(e.target.value, "user")
                        }
                        placeholder="请输入用户名"
                        style={{ width: 200 }}
                      />
                  ...
                  <Fragment>
                    <div className={styles.searchitem}>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          this.handleOrderform(e.target.value, "goods_name")
                        }
                        placeholder="请输入商品名"
                        style={{ width: 200 }}
                      />
                    ...
                    <div className={styles.searchitem}>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          this.handleOrderform(e.target.value, "partake")
                        }
                        placeholder="请输入用户名"
                        style={{ width: 200 }}
                      />
