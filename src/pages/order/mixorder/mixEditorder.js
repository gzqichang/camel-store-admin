...
class mixEditorder extends Component {
  ...
  columns = [
    ...
    },
    {
      ...
      width: 100,
      render: (t, r) =>
        `￥${r.goods_info && r.goods_info.order_amount.toFixed(2)}`
    },
    {
      title: "订单号",
      dataIndex: "order_sn",
  ...
  render() {
    const { orderdata, orderdata_item, personform } = this.state;
            ...
            extra={
              <Fragment>
                ...
                <CountDown
                  ...
                  target={
                    orderdata.end_time
                      ? new Date(orderdata.end_time).getTime()
                      : null
                  }
                />
              </Fragment>
              ...
              <FormItem label="拼团发起人">
                <Link
                  ...
                  to={{
                    ...
                    query: { id: orderdata.owner && orderdata.owner.id }
                  }}
                >
                  <img
                    src={orderdata.owner && orderdata.owner.avatar_url}
                    width="30"
                    height="30"
                    alt=""
                  />
                  <span style={{ marginLeft: 10 }}>
                    {orderdata.owner && orderdata.owner.nickname}
                  </span>
                </Link>
              </FormItem>
