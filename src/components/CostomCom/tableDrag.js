...
class tableDrag extends React.Component {
  ...
  componentDidUpdate(preprops, prestate) {
    ...
    if (
      dragTable.offsetWidth > 0 &&
      this.state.offsetWidth !== dragTable.offsetWidth
    ) {
      this.setState({
        offsetWidth: dragTable.offsetWidth,
        offsetWidthBody: bodyTable.offsetWidth
      });
    }
  }
                ...
                <div className="ant-table ant-table-small ant-table-scroll-position-left">
                  <div className="ant-table-content">
                    <div
                      ...
                      id="tableDragbody"
                      style={scroll && scroll.x ? { overflowX: "scroll" } : {}}
                    >
                      <table
                        style={
                          isNaN(widthtable) ? {} : { width: widthtable + "px" }
                        }
                        id="tableDrag"
                      >
