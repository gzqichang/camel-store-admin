export default {
  ...
  'component.globalHeader.notification': '待发货订单',//'通知',
  'component.globalHeader.notification.empty': '你已查看所有待发货订单',
  ...
  //add
  // 'menu.index': '雪梨优选后台管理',
  'component.globalHeader.feedbacklist':'用户反馈',
  'component.globalHeader.feedback.empty': '暂无反馈',
  'component.globalHeader.sendorderlist':'待发货订单',
  'menu.analysis': '概况',
  'menu.user': '客户管理',
  'menu.user.userlist': '微信用户',
  'menu.user.edituser': '微信用户详情',
  'menu.user.feedback': '用户反馈',
  'menu.good': '商品管理',
  'menu.good.goodlist': '普通商品',
  'menu.good.editgood': '普通商品详情',
  'menu.good.replacegood': '积分商品',
  'menu.good.editreplacegood': '积分商品详情',
  'menu.good.categorylist': '分类设置',
  'menu.good.editpage': '分类详情',
  'menu.good.template': '商品模板',
  'menu.good.template.goodlistTem': '普通商品模板',
  'menu.good.template.editgoodTemplate': '普通商品模板详情',
  'menu.good.template.replacetemplete': '积分商品模板',
  'menu.good.template.replaceEditTem': '积分商品模板详情',
  'menu.video': '短视频',
  'menu.video.videolist': '短视频管理',
  'menu.video.editvideo': '短视频编辑',
  'menu.video.cloudsave': '云存储',
  'menu.source': '素材管理',
  'menu.offline': '扫码支付',
  'menu.offline.orders': '扫码支付记录',
  'menu.offline.code': '收款码',
  'menu.order': '订单管理',
  'menu.order.orderlist': '普通订单',
  'menu.order.mixOrderlist': '拼团订单',
  'menu.order.replOrderlist': '积分商品订单',
  'menu.order.outlineOrderlist': '线下支付订单',
  'menu.order.editorder': '普通订单详情',
  'menu.order.mixEditorder': '拼团订单详情',
  'menu.order.mixorderDetail': '个人拼团订单详情',
  'menu.order.editreplorder': '积分订单详情',
  'menu.order.mixsuborderDetail': '个人拼团订单详情',
  'menu.trade': '营销工具',
  'menu.trade.userlevel': '会员',
  'menu.trade.prerecharge': '充值',
  'menu.trade.share': '分享管理',
  'menu.trade.share.expand': '分享设置',
  'menu.trade.share.profie': '分享积分记录',
  'menu.trade.distribution': '分销管理',
  'menu.trade.distribution.expand': '分销设置',
  'menu.trade.distribution.team': '团队设置',
  'menu.trade.distribution.teamDetail': '团队详情',
  'menu.trade.distribution.tradeprofie': '分销返佣',
  'menu.trade.shopmessage': '促销消息',
  'menu.trade.editmessage': '促销消息详情',
  'menu.trade.swiperlist': '极简版首页设置',
  'menu.trade.editswiper': '首页海报详情',
  'menu.trade.indexpage': '全功能版首页设置',
  'menu.trade.hotword': '搜索热词',
  'menu.finance': '财务管理',
  'menu.finance.recharge': '充值记录',
  'menu.finance.trademoney': '提现管理',
  'menu.finance.financeprofile': '积分记录',
  'menu.statistic': '统计分析',
  'menu.setting': '系统设置',
  'menu.setting.quacontent': '买家须知',
  'menu.setting.editqua': '买家须知详情',
  'menu.setting.storelist': '门店信息',
  'menu.setting.editstore': '门店详情',
  'menu.setting.adminuser': '管理员账号',
  'menu.setting.editadmin': '管理员账号详情',
  'menu.setting.logo': '店铺图标',
  'menu.setting.extensions': '插件市场',
  'menu.wechat': '小程序设置',
  'menu.wechat.base': '基础信息',
  'menu.wechat.pay': '支付设置',
  'menu.setting.device': '设备管理',
  'menu.setting.pay': '支付设置',
  'menu.setting.shortMessage': '短信管理',
  'menu.doc': '文档中心',
  'menu.doc.entercourse': '入门教程',
  'menu.doc.function': '功能说明',
  'menu.person': '个人中心',
  'menu.person.personpwd': '修改密码',
  //------
